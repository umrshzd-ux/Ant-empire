// ===== CONFIGURATION & BALANCE CONSTANTS =====

var BAL = {
  baseEggLayTime: 10,
  eggLayTimePerWorker: 2.5,
  baseHatchTime: 10,
  foodPerTrip: 3,
  foodPerTripDiminished: 1,
  baseFoodCap: 60,
  foodCapPerStorage: 50,
  storageCost: 60,
  storageCostMult: 0.25,
  maxStorage: 8,
  nurseryCost: 100,
  soldierChamberCost: 150,
  researchChamberCost: 200,
  scoutChamberCost: 180,
  soldierHealth: 55,
  soldierDamage: 10,
  soldierAttackCD: 1.0,
  soldierRegenDelay: 5,
  soldierRegenRate: 0.5,
  soldierRespawnTime: 25,
  spiderHealth: 30,
  spiderDamage: 6,
  spiderAttackCD: 1.4,
  spiderSpeed: 0.35,
  ...
  scoutRewardMax: 8,
  scoutGemChance: 0.3,
  expansionTripsNeeded: 15,
  maxRenderedAnts: 50,
  workerBaseScale: 1.2,
  workerScalePerUpgrade: 0.12,
  soldierMandibleBaseThickness: 0.03,
  soldierMandibleScalePerUpgrade: 0.012,
  queenBaseScale: 3.5,
  queenScalePer5Levels: 0.25,
  eventIntervalMin: 35,
  eventIntervalMax: 60,
  rareAntChance: 0.05,
  weatherIntervalMin: 70,
  weatherIntervalMax: 110,
  weatherDuration: 25,
  nestEvolveLevels: [4, 8, 14, 22, 32, 45, 60],
  offlineEfficiency: 0.6,
  gemPerLevel: 1,
  earlyGameBoostDuration: 300,
  earlyGameEggMultiplier: 0.7,
  virtualFoodPerSecond: 0.15,
  maxNursery: 3,
  maxSoldierChambers: 5,
  maxScoutChambers: 3,
  soldierRowStart: 10,
  researchRowStart: 16,
  scoutRowStart: 22,
  spiderSneakChance: 0.1,
  spiderGuardRadius: 2.5,
  bossIntervalMin: 1500,
  bossIntervalMax: 2100,
  bossHealthQueen: 250,
  bossHealthBeetle: 400,
  bossHealthWasp: 150,
  bossDamageQueen: 15,
  bossDamageBeetle: 10,
  bossDamageWasp: 20,
  ...
  summonCost: 5,
  prestigeLevelReq: 30,
  prestigePPPerLevel: 0.5,
  prestigeBasePP: 3,
  workerRebalanceInterval: 300,
  speedBoostDuration: 300,
  evolutionUnlockLevel: 8,
  ...
  bossHealthCentipede: 300,
  bossDamageCentipede: 18,
  bossSpeedCentipede: 0.25,
  bossHealthHydra: 350,
  bossDamageHydra: 14,
  bossSpeedHydra: 0.15,
  bossHealthWyrm: 400,
...
var GEM_ITEMS = {
  goldenEgg: { name: "Golden Ant Egg", cost: 5, oneTime: true },
  soldierArmor: { name: "Soldier Armor", cost: 8, oneTime: true },
  queenBless: { name: "Queen's Blessing", cost: 7, oneTime: true },
  scoutMap: { name: "Scout's Map", cost: 6, oneTime: true },
  speedBoost: { name: "Speed Boost (5min)", cost: 3, oneTime: false },
  instantHatch: { name: "Instant Hatch", cost: 2, oneTime: false },
  goldenSkin: { name: "Golden Skin", cost: 10, oneTime: true }
};
...
var DAILY_REWARDS = [
  ...
  { day: 5, gems: 3 },
  { day: 6, gems: 3 },
  { day: 7, gems: 5, special: true, bonusItem: "goldenEgg" }
];

var ACHIEVEMENTS = [
  { id: "hatch", name: "Hatch Master", icon: "🐣", tier: "bronze", hidden: false, tiers: [
    { req: 10, desc: "Hatch 10 workers", reward: 2 },
    { req: 50, desc: "Hatch 50 workers", reward: 5 },
    { req: 100, desc: "Hatch 100 workers", reward: 8 },
    { req: 500, desc: "Hatch 500 workers", reward: 12 },
    { req: 1000, desc: "Hatch 1,000 workers", reward: 20 },
    { req: 5000, desc: "Hatch 5,000 workers", reward: 30 },
    { req: 10000, desc: "Hatch 10,000 workers", reward: 50 }
  ]},
  { id: "spider", name: "Spider Slayer", icon: "🕷️", tier: "bronze", hidden: false, tiers: [
    { req: 10, desc: "Defeat 10 spiders", reward: 3 },
    { req: 50, desc: "Defeat 50 spiders", reward: 8 },
    { req: 100, desc: "Defeat 100 spiders", reward: 12 },
    { req: 500, desc: "Defeat 500 spiders", reward: 18 },
    { req: 1000, desc: "Defeat 1,000 spiders", reward: 25 },
    { req: 5000, desc: "Defeat 5,000 spiders", reward: 40 }
  ]},
  { id: "boss", name: "Boss Hunter", icon: "💀", tier: "gold", hidden: false, tiers: [
    { req: 1, desc: "Defeat 1 boss", reward: 10 },
    { req: 5, desc: "Defeat 5 bosses", reward: 15 },
    { req: 10, desc: "Defeat 10 bosses", reward: 20 },
    { req: 25, desc: "Defeat 25 bosses", reward: 30 },
    { req: 50, desc: "Defeat 50 bosses", reward: 40 },
    { req: 100, desc: "Defeat 100 bosses", reward: 60 }
  ]},
  { id: "level", name: "Colony Level", icon: "⭐", tier: "bronze", hidden: false, tiers: [
    { req: 5, desc: "Reach Level 5", reward: 1 },
    { req: 15, desc: "Reach Level 15", reward: 5 },
    { req: 30, desc: "Reach Level 30", reward: 10 },
    { req: 50, desc: "Reach Level 50", reward: 15 },
    { req: 75, desc: "Reach Level 75", reward: 25 },
    { req: 100, desc: "Reach Level 100", reward: 40 }
  ]},
  { id: "storage", name: "Vast Storage", icon: "🌾", tier: "bronze", hidden: false, tiers: [
    { req: 1000, desc: "1,000 food capacity", reward: 5 },
    { req: 5000, desc: "5,000 food capacity", reward: 10 },
    { req: 10000, desc: "10,000 food capacity", reward: 15 },
    { req: 50000, desc: "50,000 food capacity", reward: 25 },
    { req: 100000, desc: "100,000 food capacity", reward: 40 }
  ]},
  { id: "prestige", name: "Prestige Journey", icon: "✨", tier: "gold", hidden: false, tiers: [
    { req: 1, desc: "Prestige 1 time", reward: 15 },
    { req: 3, desc: "Prestige 3 times", reward: 20 },
    { req: 5, desc: "Prestige 5 times", reward: 30 },
    { req: 10, desc: "Prestige 10 times", reward: 40 },
    { req: 25, desc: "Prestige 25 times", reward: 60 },
    { req: 50, desc: "Prestige 50 times", reward: 100 }
  ]},
  ...
  { id: "rare", name: "Rare Collector", icon: "💗", tier: "gold", hidden: false, tiers: [
    { req: 3, desc: "Hatch 3 rare ants", reward: 5 },
    { req: 10, desc: "Hatch 10 rare ants", reward: 10 },
    { req: 25, desc: "Hatch 25 rare ants", reward: 20 },
    { req: 50, desc: "Hatch 50 rare ants", reward: 35 }
  ]},
  { id: "gem", name: "Gem Hoarder", icon: "💎", tier: "silver", hidden: false, tiers: [
    { req: 20, desc: "Earn 20 gems total", reward: 3 },
    { req: 100, desc: "Earn 100 gems total", reward: 8 },
    { req: 500, desc: "Earn 500 gems total", reward: 15 },
    { req: 1000, desc: "Earn 1,000 gems total", reward: 25 },
    { req: 5000, desc: "Earn 5,000 gems total", reward: 40 }
  ]},
  { id: "explorer", name: "Explorer", icon: "🌿", tier: "gold", hidden: false, tiers: [
    { req: 1, desc: "Unlock Meadow", reward: 3 },
    { req: 2, desc: "Unlock Forest Edge", reward: 5 },
    { req: 3, desc: "Unlock Riverside", reward: 8 },
    { req: 4, desc: "Unlock Deep Woods", reward: 12 }
  ]},
  { id: "feast", name: "Feast King", icon: "🍞", tier: "silver", hidden: false, tiers: [
    { req: 10000, desc: "Earn 10K lifetime food", reward: 5 },
    { req: 100000, desc: "Earn 100K lifetime food", reward: 10 },
    { req: 1000000, desc: "Earn 1M lifetime food", reward: 20 },
    { req: 10000000, desc: "Earn 10M lifetime food", reward: 35 }
  ]},
  { id: "time", name: "Time Flies", icon: "⏰", tier: "silver", hidden: false, tiers: [
    { req: 3600, desc: "Play 1 hour", reward: 5 },
    { req: 18000, desc: "Play 5 hours", reward: 10 },
    { req: 72000, desc: "Play 20 hours", reward: 20 },
    { req: 360000, desc: "Play 100 hours", reward: 35 },
    { req: 1800000, desc: "Play 500 hours", reward: 60 }
  ]},
  { id: "rally", name: "Rally Captain", icon: "💨", tier: "silver", hidden: false, tiers: [
    { req: 10, desc: "Use Rally 10 times", reward: 5 },
    { req: 50, desc: "Use Rally 50 times", reward: 10 },
    { req: 100, desc: "Use Rally 100 times", reward: 20 },
    { req: 500, desc: "Use Rally 500 times", reward: 35 }
  ]},
  { id: "surge", name: "Surge Master", icon: "👑", tier: "gold", hidden: false, tiers: [
    { req: 5, desc: "Collect 5 Surges", reward: 8 },
    { req: 25, desc: "Collect 25 Surges", reward: 15 },
    { req: 50, desc: "Collect 50 Surges", reward: 25 },
    { req: 100, desc: "Collect 100 Surges", reward: 40 }
  ]},
  { id: "night", name: "Night Owl", icon: "🦉", tier: "silver", hidden: true, tiers: [
    { req: 1, desc: "Survive 1 night", reward: 5 },
    { req: 5, desc: "Survive 5 nights", reward: 10 },
    { req: 10, desc: "Survive 10 nights", reward: 20 },
    { req: 25, desc: "Survive 25 nights", reward: 35 }
  ]},
  { id: "speed", name: "Speed Demon", icon: "⚡", tier: "gold", hidden: true, tiers: [
    { req: 1, desc: "Prestige in under 2 hours", reward: 20 },
    { req: 2, desc: "Prestige in under 1 hour", reward: 40 },
  ...
  { id: "cave", name: "Cave Explorer", icon: "🕳️", tier: "silver", hidden: false, tiers: [
    { req: 10, desc: "Defeat Cave Centipede 10 times", reward: 5 },
    { req: 25, desc: "Defeat Cave Centipede 25 times", reward: 10 },
    { req: 50, desc: "Defeat Cave Centipede 50 times", reward: 15 }
  ]},
  { id: "swamp", name: "Swamp Survivor", icon: "🌿", tier: "silver", hidden: false, tiers: [
    { req: 10, desc: "Defeat Swamp Hydra 10 times", reward: 5 },
    { req: 25, desc: "Defeat Swamp Hydra 25 times", reward: 10 },
  ...
  { id: "mountain", name: "Mountain Conqueror", icon: "🏔️", tier: "silver", hidden: false, tiers: [
    { req: 10, desc: "Defeat Mountain Wyrm 10 times", reward: 5 },
    { req: 25, desc: "Defeat Mountain Wyrm 25 times", reward: 10 },
    { req: 50, desc: "Defeat Mountain Wyrm 50 times", reward: 15 }
  ]},
  { id: "ascend1", name: "Ascension Novice", icon: "⬆️", tier: "gold", hidden: false, tiers: [
    { req: 1, desc: "Ascend 1 time", reward: 10 },
    { req: 3, desc: "Ascend 3 times", reward: 20 },
    { req: 5, desc: "Ascend 5 times", reward: 30 },
    { req: 10, desc: "Ascend 10 times", reward: 50 }
  ]},
  { id: "ascend2", name: "Eternal Monarch", icon: "👑", tier: "platinum", hidden: false, tiers: [
    { req: 5, desc: "Spend 5 AP in Ascension Shop", reward: 15 },
    { req: 10, desc: "Spend 10 AP", reward: 25 },
    { req: 15, desc: "Spend 15 AP", reward: 40 },
    { req: 20, desc: "Spend 20 AP", reward: 60 }
  ]},
  ...
  { id: "poisonProof", name: "Poison Resistant", icon: "🛡️", tier: "silver", hidden: false, tiers: [
    { req: 50, desc: "Kill 50 Centipedes", reward: 10 },
    { req: 200, desc: "Kill 200 Centipedes", reward: 20 }
  ]},
  { id: "regenerationSlayer", name: "Regeneration Slayer", icon: "⚔️", tier: "silver", hidden: false, tiers: [
    { req: 50, desc: "Kill 50 Hydras", reward: 10 },
    { req: 200, desc: "Kill 200 Hydras", reward: 20 }
  ]},
  { id: "frostBreaker", name: "Frost Breaker", icon: "❄️", tier: "silver", hidden: false, tiers: [
    { req: 50, desc: "Kill 50 Wyrms", reward: 10 },
    { req: 200, desc: "Kill 200 Wyrms", reward: 20 }
  ]},
  { id: "ascendFast", name: "Speed Ascender", icon: "⚡", tier: "gold", hidden: true, tiers: [
    { req: 1, desc: "Ascend within 24h of starting a fresh run", reward: 15 },
    { req: 2, desc: "Ascend within 12h of starting", reward: 30 }
  ]},
...
var EVENTS = [
  ...
  { name: "Gem Shard", emoji: "💠", action: function() { addGems(3); emitParticles(new THREE.Vector3(TX+2, GTY+0.5, TCZ-2), 30, 0xff44ff, 0.05, 1.0, 0.6); } },
